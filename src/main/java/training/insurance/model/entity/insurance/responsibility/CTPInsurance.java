package training.insurance.model.entity.insurance.responsibility;
...
public class CTPInsurance extends AbstractInsurance {
    ...
    public CTPInsurance(int id, BigDecimal sumInsured, double riskDegree, String carNumber, List<String> drivers) {
        super(id, NAME, sumInsured, riskDegree);
        this.carNumber = carNumber;
        this.drivers = drivers;
    }

    public CTPInsurance(int id, BigDecimal sumInsured, double riskDegree, String carNumber) {
        super(id, NAME, sumInsured, riskDegree);
        this.carNumber = carNumber;
    }
